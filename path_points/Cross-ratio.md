...
The most symmetric cross-ratio occurs when <math>\lambda = e^{\pm i\pi/3}</math>. These are then the only two possible values of the cross-ratio, and these are acted on according to the sign of the permutation.
